...
{
    public partial class frmSistemaAcademico_AñoElectivo : Form
    {
        private bool IsNuevo = false;
        public frmSistemaAcademico_AñoElectivo()
        {
            InitializeComponent();
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        rptaDatosBasicos = fSistema_Academico_Año.Guardar_DatosBasicos(this.TBAuto.Text, this.TBAño.Text, this.CBEstado.Text, this.TBDescripcion.Text);
                    }
