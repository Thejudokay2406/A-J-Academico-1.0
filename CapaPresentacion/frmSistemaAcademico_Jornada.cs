        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        rptaDatosBasicos = fSistema_Academico_Jornadas.Guardar_DatosBasicos(this.TBAuto.Text, this.TBJornada.Text, this.TBAño.Text, this.CBEstado.Text, this.TBDescripcion.Text);
                    }
